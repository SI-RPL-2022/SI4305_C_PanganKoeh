...
@section('content')
    ...
    <div class="beranda">
        ...
        @endif
        <h2 align="center" style="color: #677A68; font-family: scada; font-style: normal; font-weight: 400; line-height: 32px; padding-top: 50px"><b>EDIT DATA KOMODITAS</b></h2>
        <div class="container" style="padding-top: 50px; padding-bottom: 300px" align="center">
            <div class="card" style="width: 65rem;">
                <div class="card-body" style="padding-top: 10px;">
                    <form action="/MasterDataKomoditas/update/{{ $info->id }}" method="post" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="row mb-3">
                            <input type="hidden" name="oldImage" value="{{ $info->gambar }}">
                            ...
                            <div class="col-sm-10">
                                ...
                                @enderror
                                @if ($info->gambar)
                                    <img src="{{ asset('storage/' . $info->gambar) }}" style="height: 200px; object-fit: cover;text-align: left" class="img-preview img-fluid pt-2">
                                @endif
                            </div>
                        </div>
                        <div class="mb-3">
